    ...
    <section className="px-5 lg:px-16 xl:px-24 2xl:px-40 py-10">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="text-center order-first lg:order-last relative">
          ...
          <Connect />
          <div className="text-left w-[80%] sm:w-[60%] md:w-[50%] lg:w-[75%] xl:w-[70%] 2xL:w-[60%] m-auto">
            <p className="text-sm font-light text-white mt-10">
              <span className="font-semibold text-2xl">FREE MINT</span> for the
              first 50 NFTs (FCFS)
            </p>
            <p className="text-sm font-light text-white mt-3">
              <span className="font-semibold">- 0.02 ETH</span> {"—>"} from 51
              to 200
            </p>
            ...
            <p className="text-sm font-light text-white mt-5">
              <span className="font-semibold text-2xl">GAS FEE REFUND*</span> if
              you buy 10 NFTs
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 mt-20 md:mt-28">
        <div>
          ...
          <p className="text-white text-sm md:text-base font-light mt-5">
            Crypto Clones is not associated with CloneX
          </p>
        </div>
        <div>
          <iframe
